...
sysfonts::font_add(
  "Rockwell", 
  "C:/USERS/SCHUELKE/APPDATA/LOCAL/MICROSOFT/WINDOWS/FONTS/ROCKWELL-REGULAR.TTF"
)
showtext::showtext_auto()

sticker(subplot = "man/figures/tri-logo.png",
        s_x = 1,
        s_y = 1.2,
        s_width = 0.75,
        s_height = 0.75,
...
The goal of ``r params$package`` is to provide helpful functions for the [Joint Office of Strategic Planning](https://medicine.wustl.edu/josp/).
